...
public class Constants {
    ...
    private static final String HOST = "192.168.1.139";
    ...
    //验证手机号
    public static final String VALIDATE_PHONE_URL = BASE_URL + "";
    //重置密码
    public static final String RESETTING_PASSWORD_URL = BASE_URL + "";
    //验证登录
    public static final String VALIDATE_LOGIN_URL = BASE_URL + "";
